...
revoke select, insert, update, delete on patients, biomarker_panels, assessment_sessions from anon;
grant select, insert, update, delete on patients, biomarker_panels, assessment_sessions to authenticated;
...
-- including delete policies needed to discard aborted sessions.
